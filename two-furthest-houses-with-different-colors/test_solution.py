...
class TestMaxCompatibilitySum(unittest.TestCase):
    ...
    def test_two_different(self):
        self.assertEqual(self.s.maxCompatibilitySum([99, 0]), 1)
    ...
    def test_max_length(self):
        ...
        colors = [1] * 100
        colors[-1] = 2
        self.assertEqual(self.s.maxCompatibilitySum(colors), 99)

    def test_all_different(self):
        self.assertEqual(self.s.maxCompatibilitySum([1, 2, 3, 4, 5]), 4)

    def test_same_endpoints_diff_near_start(self):
        # Optimal pair is (1, 4) → distance 3
        self.assertEqual(self.s.maxCompatibilitySum([1, 2, 1, 1, 1]), 3)
