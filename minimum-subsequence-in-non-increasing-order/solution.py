...
class TestMinSubsequence(unittest.TestCase):
    ...
    def test_example1(self):
        self.assertEqual(self.s.min_subsequence([4, 3, 10, 9, 8]), [10, 9])

    def test_example2(self):
        self.assertEqual(self.s.min_subsequence([4, 4, 7, 6, 7]), [7, 7, 6])

    def test_single_element(self):
        self.assertEqual(self.s.min_subsequence([5]), [5])

    def test_all_equal(self):
        self.assertEqual(self.s.min_subsequence([3, 3, 3]), [3, 3])

    def test_two_elements(self):
        self.assertEqual(self.s.min_subsequence([1, 2]), [2])

    def test_already_sorted_desc(self):
        self.assertEqual(self.s.min_subsequence([10, 5, 1]), [10])
