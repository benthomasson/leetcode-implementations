...
class Solution:
    def min_operations(self, text: str, brokenLetters: str) -> int:
...
class TestSolution(unittest.TestCase):
    ...
    def test_single_word(self):
        self.assertEqual(self.s.min_operations("abc", "a"), 0)

    def test_single_char_words(self):
        self.assertEqual(self.s.min_operations("a b c", "b"), 2)

    def test_all_broken(self):
        self.assertEqual(self.s.min_operations("abc", "abc"), 0)
