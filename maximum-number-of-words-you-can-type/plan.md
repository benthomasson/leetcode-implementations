...
Task: Solve the LeetCode problem "maximum-number-of-words-you-can-type":
...
Plan written to `planner/PLAN.md`. Simple set-based approach — O(n+m) time, use `set.isdisjoint()` per word to check typeability.
